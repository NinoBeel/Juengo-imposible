...
var sam;
copita = createSprite(375,200, 20, 20);
...
function draw() {
  ...
  rect(345,120,52,140);
   if (gameState== "serve") {
     textSize(18);
     fill("red");
     text("Presiona las flechas Left/right para moverte", 40, 22);
     if (keyDown("right")) {
       sam.x =sam.x+2 ;
       gameState = "play";
     }
   ...
   if (sam.isTouching(copita)) {
     fill("Black");
     textSize(30);
     text("You win!", 165, 200);
     stopSound("assets/category_loops/pulsating_discovery_loop1.mp3");
     playSound("assets/category_achievements/bubbly_game_achievement_sound.mp3", true);
   }
